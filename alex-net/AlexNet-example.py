...
current_path = os.path.join(os.getcwd(), 'alex_net')
file_name = os.path.join('..', '..', os.getcwd(), 'images', 'bernese.jpg)
...
# Preprocesiranje slike: promjena veličine, normalizacija itd.
